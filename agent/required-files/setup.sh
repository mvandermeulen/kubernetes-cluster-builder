...
sudo cp --remove-destination /home/"$1"/required-files/timesyncd.conf /etc/systemd/timesyncd.conf
...
sudo mv /home/"$1"/required-files/.vimrc /home/"$1"/



# -------- COPY THE REQUIRED FILES TO THE HOME PATH
sudo mv /home/"$1"/required-files/run-me-first-as-sudo.sh /home/"$1"/
sudo mv /home/"$1"/required-files/01-netcfg.yaml /home/"$1"/
